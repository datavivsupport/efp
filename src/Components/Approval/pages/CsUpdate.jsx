            ...
            <Card className={Styles.card} bordered title={<CardHeader icon="mingcute:ship-fill" title="OTHER DETAILS" open={open.otherDetails} onToggle={() => toggle("otherDetails")} />}>
              <div style={{ display: open.otherDetails ? "block" : "none" }}>
                <Row gutter={16}>
                  ...
                  {isCrossTrade && <Col xs={24} md={6}><Form.Item className={Styles.formLabel} label="Remarks"><TextArea className={Styles.textAreaField} placeholder="Remarks" value={getShipmentRemarks(jobData)} disabled autoSize={{ minRows: 2 }} /></Form.Item></Col>}
          ...
          <Card className={Styles.card} bordered title={<CardHeader icon="mdi:anchor" title="BOOKING DETAILS" open={open.booking} onToggle={() => toggle("booking")} />}>
              <div style={{ display: open.booking ? "block" : "none" }}>
                <Row gutter={16}>
                  ...
                  <Col xs={24} md={6}><Form.Item className={Styles.formLabel} label="Booking Vessel" name="booking_vessel" rules={[{ required: true, message: "Required" }]}><Input placeholder="Booking Vessel" disabled={false} /></Form.Item></Col>
                  <Col xs={24} md={6}><Form.Item className={Styles.formLabel} label="Booking Voyage" name="booking_voyage" rules={[{ required: true, message: "Required" }]}><Input placeholder="Booking Voyage" disabled={false} /></Form.Item></Col>
                  ...
                  <Col xs={24} md={6}><Form.Item label="Latest ETA" name="vsl_latest_eta" className={Styles.formLabel} rules={[{ required: false, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={false} format="DD-MM-YYYY" /></Form.Item></Col>
                  ...
                  <Col xs={24} md={6}><Form.Item label="POD ETA" name="pod_eta" className={Styles.formLabel} rules={[{ required: false, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={false} format="DD-MM-YYYY" /></Form.Item></Col>
