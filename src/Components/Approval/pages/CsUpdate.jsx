            ...
            <Card className={Styles.card} bordered title={<CardHeader icon="mdi:anchor" title="BOOKING DETAILS" open={open.booking} onToggle={() => toggle("booking")} />}>
              <div style={{ display: open.booking ? "block" : "none" }}>
                <Row gutter={16}>
                  ...
                  <Col xs={24} md={6}><Form.Item className={Styles.formLabel} label="Vessel ETA Date" name="vessel_eta" rules={[{ required: true, message: "Required" }]}><DatePicker format="YYYY-MM-DD" style={{ width: "100%" }} disabled={isBookingSectionLocked} /></Form.Item></Col>
                  <Col xs={24} md={6}><Form.Item label="Initial ETA" name="vsl_initial_eta" className={Styles.formLabel} rules={[{ required: true, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={isBookingSectionLocked} format="YYYY-MM-DD" /></Form.Item></Col>
                  <Col xs={24} md={6}><Form.Item label="Latest ETA" name="vsl_latest_eta" className={Styles.formLabel} rules={[{ required: true, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={isBookingSectionLocked} format="YYYY-MM-DD" /></Form.Item></Col>
                  <Col xs={24} md={6}><Form.Item label="ETD" name="vsl_etd" className={Styles.formLabel} rules={[{ required: true, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={isBookingSectionLocked} format="YYYY-MM-DD" /></Form.Item></Col>
                  <Col xs={24} md={6}><Form.Item label="POD ETA" name="pod_eta" className={Styles.formLabel} rules={[{ required: true, message: "Required" }]}><DatePicker style={{ width: '100%' }} disabled={isBookingSectionLocked} format="YYYY-MM-DD" /></Form.Item></Col>
                  ...
                  <Col xs={24} md={6}><Form.Item className={Styles.formLabel} label="Load List/SI Cut Off Date" name="si_cut_off_date" rules={[{ required: true, message: "Required" }]}><DatePicker format="YYYY-MM-DD" style={{ width: "100%" }} disabled={isBookingSectionLocked} /></Form.Item></Col>
